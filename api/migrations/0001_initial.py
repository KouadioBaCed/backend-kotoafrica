    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clothing_size', models.CharField(blank=True, max_length=10)),
                ('gender', models.CharField(choices=[('homme', 'Homme'), ('femme', 'Femme'), ('enfant', 'Enfant')], max_length=10)),
                ('photo', models.ImageField(blank=True, null=True, upload_to='quote_requests/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('client', 'Client'), ('african_supplier', 'Fournisseur Africain'), ('asian_supplier', 'Fournisseur Asiatique'), ('admin', 'Administrateur')], default='client', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('pending', 'En attente'), ('partial', 'Partiel'), ('completed', 'Complet')], default='pending', max_length=20)),
                ('shipping_method', models.CharField(choices=[('air_rapide', 'Aérien Rapide'), ('air_express', 'Aérien Express'), ('sea_no_motor', 'Maritime sans Moteur'), ('sea_with_motor', 'Maritime avec Moteur'), ('local', 'Livraison Locale')], default='local', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_type', models.CharField(choices=[('deposit', 'Acompte'), ('balance', 'Solde')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origin', models.CharField(choices=[('africa', 'Afrique'), ('asia', 'Asie')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('supplier_type', models.CharField(choices=[('african', 'Africain'), ('asian', 'Asiatique')], max_length=10)),
