"""
Django settings for koto_africa project.
"""
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-koto-africa-secret-key-change-in-production')
...
WSGI_APPLICATION = 'koto_africa.wsgi.application'
